...
Сделать:
-) Если производилось удаление в неориентированном графе, -1 в массиве ху может ломать функции
2) Переделать Краскала чтобы запускался только на неориентированном графе
@author: M.Lobanov
"""
class Bucket:
